    ...
    inner class  AnimalsAdapter: BaseAdapter {
        ...
        override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
            ...
            if( animal.isKiller ==true) {
                ...
                var myView = inflator.inflate(R.layout.animal_tickect, null)


                myView.findViewById<TextView>(R.id.tv_name).text = animal.name!!
                myView.findViewById<TextView>(R.id.tv_des).text = animal.des!!
